---
layout: post
title: Free My Desktop - 1.2.1
date: 2018-11-15 11:28:23.000000000 +01:00
type: post
published: true
status: publish
categories: [Tech, Me]
...
The fourth update for Free My Desktop is now available.

This update fixes a bug with minimal mode and makes it more accessible. You can now turn it on from the menubar directly without having to manually type in commands in the Terminal.

When minimalist mode is on clicking on the menubar icon will toggle FreeMyDesktop and hide or show the desktop. To show the menu you will need to right click on the icon.

_Want access to the Beta channel? [Subscribe to the newsletter][4]!_

**New:**

- Turn minimalist mode on and off from the Terminal
